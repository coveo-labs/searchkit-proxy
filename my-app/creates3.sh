...
aws s3api put-public-access-block  --bucket searchkitproxy-demo  --public-access-block-configuration "BlockPublicAcls=false,IgnorePublicAcls=false,BlockPublicPolicy=false,RestrictPublicBuckets=false"
